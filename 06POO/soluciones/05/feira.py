...
if __name__ == "__main__":
    feira = Feira()
    feira.anhadir_entradas("compra-venta", 300, 10)
    feira.anhadir_entradas("sala principal", 2000, 5)
    feira.anhadir_entradas("zona vip", 20, 100)
    feira.anhadir_entradas("compra-venta", 400, 20)
    print(feira)
    pass